    ...
    function installCode(code_0){
      ...
      if (sensormleditor.__errFn) {
        script.onerror = function(){
          sensormleditor.__errFn($intern_4, new Error($intern_22 + code_0));
        }
        ;
      }
